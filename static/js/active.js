    ...
    if ($.fn.slick) {
      ...
      if (heroSlider.slider_1.length) {
        ...
        heroSlider.slider_2_addClass = () => {
          heroSlider.slider_1
            .find(".slick-slide")
            .removeClass("prevSlide nextSlide");
          heroSlider.getSliderCurrent =
            heroSlider.slider_1.find(".slick-current");
          heroSlider.getPrevSlide = heroSlider.getSliderCurrent
            .prev(".slick-slide")
            .addClass("prevSlide");
          heroSlider.getNextSlide = heroSlider.getSliderCurrent
            .next(".slick-slide")
            .addClass("nextSlide");
        };
        heroSlider.slider_2_addClass();
        ...
        heroSlider.slider_1.on("beforeChange", function () {
          heroSlider.slider_1
            .find(".slick-slide .st--inner > *, .slick-slide .st--vdo--btn")
        ...
        heroSlider.slider_1.on("afterChange", function () {
          heroSlider.slider_2_addClass();
          heroSlider.slider_1
            .find(".slick-active .st--inner > *, .slick-slide .st--vdo--btn")
            .css("opacity", "1")
      ...
      if (heroSlider.slider_2.length) {
        ...
        heroSlider.slider_2.slick({
          prevArrow:
            '<div class="slick--prev"><i class="zmdi zmdi-arrow-left"></i></div>',
          nextArrow:
            '<div class="slick--next"><i class="zmdi zmdi-arrow-right"></i></div>',
          cssEase: "cubic-bezier(0.645, 0.045, 0.355, 1.000)",
        ...
        heroSlider.slider_2.on("afterChange", function () {
          heroSlider.animName = $(this).find(
            ".slick-current [data-slide-animation]"
          );
          heroSlider.animName.addClass("animated");
          heroSlider.animName.each(function () {
            var animVal = $(this).attr("data-slide-animation"),
      ...
      if (stCarousel.catCarousel_1.length) {
        stCarousel.catCarousel_1.slick({
          slidesToShow: 3,
          prevArrow:
            '<div class="slick--prev"><i class="zmdi zmdi-chevron-left"></i></div>',
          nextArrow:
            '<div class="slick--next"><i class="zmdi zmdi-chevron-right"></i></div>',
          infinite: true,
          autoplay: true,
          cssEase: "cubic-bezier(0.645, 0.045, 0.355, 1.000)",
          responsive: [
      ...
      if (stCarousel.widCarousel_1.length) {
        stCarousel.widCarousel_1.slick({
          prevArrow:
            '<div class="slick--prev"><i class="zmdi zmdi-long-arrow-left"></i></div>',
          nextArrow:
            '<div class="slick--next"><i class="zmdi zmdi-long-arrow-right"></i></div>',
          infinite: true,
          autoplay: true,
          autoplaySpeed: 4000,
          fade: true,
      ...
      if (
        stCarousel.stPostCarousel_2.length &&
        stCarousel.stPostCarousel_2_inner.length > 1
      ) {
      ...
      if (
        stCarousel.stPostCarousel_3.length &&
        stCarousel.stPostCarousel_3_inner.length > 1
      ) {
